...
.risk-low { background-color: #dbeafe; color: #1e3a8a; border: 2px solid #2563eb; }

/* Sentinel narrative box */
.sentinel-box {
...
<div class="hero-banner">
    <span class="hero-tag">CLINICAL DECISION SUPPORT</span>
    <h1>🩺 PulsePoint AI</h1>
    <p>See deterioration before it becomes an emergency. A two-module clinical risk
    platform — sepsis early-warning during ICU stays, and 30-day readmission risk at
    discharge. Built on public, de-identified data. Prototype for demonstration only —
    not a medical device, not deployed on real patients.</p>
</div>
""", unsafe_allow_html=True)
